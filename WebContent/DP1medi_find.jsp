          ...
          *************************/
          ...
          if ((j-1)%6 == 0) // 블록체인ID
          {
            try
            {
              ...
              cell.innerHTML = "<a href=\"./DP2medi_chart.jsp?p1addr="+st[j]+"\">"+st[j]+"</a>";
            }
            catch (e)
            {
              alert(e);
      ...
      <div class="w3-row-padding w3-center w3-margin-top">  
        ...
        <table  class="w3-table" style="background-color: #eeeeee;">
          <tr style="border: 1px solid #888888;">
            ...
            <td style="text-align: center;" rowspan=2><input type="button" class="w3-btn w3-white w3-border w3-border-dark-grey w3-round-large" value=" 조 회 " onClick="bSearch()"></td>
          </tr>
          <tr style="border: 1px solid #888888;">
            <td>주민번호</td>
